# HIPAA Mappings to Wellth Controls

Below is a list of HIPAA Safeguards and Requirements and the Wellth controls in place to meet those.

| **Administrative Controls** HIPAA Rule | Wellth Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | Wellth Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | Wellth Control
---------------- | ----------------
