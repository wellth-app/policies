...
* *Event*: An event is defined as an occurrence that does not constitute a serious adverse effect on Wellth, its operations, or its Customers, though it may be less than optimal. Examples of events include, but are not limited to:
...
* *Organization*: For the purposes of this policy, the term “organization” shall mean Wellth.

* *Partner*: Contractual bound 3rd party vendor with integration with the Wellth Platform. May offer Add-on services.

* *Platform*: The overall technical environment of Wellth.
